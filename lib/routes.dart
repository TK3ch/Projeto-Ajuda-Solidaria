...
import 'package:ajuda_solidaria/screens/contas_screen.dart';
import 'package:ajuda_solidaria/screens/localidades_screen.dart';
...
class AppRoutes {
  ...
  static const String localidades = '/localidades';
  ...
  static final Map<String, WidgetBuilder> staticRoutes = {
    ...
    contas: (_) => const ContasScreen(),
    localidades: (_) => const LocalidadesScreen()
